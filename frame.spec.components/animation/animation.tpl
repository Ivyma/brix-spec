...
<div class="spec-section mb40">
    ...
    <div>
        <div class="mb60">
            <div class="row">
                <div class="col-md-4">
                    <div class="fontsize-16">建⽴真实的动效场景空间</div>
                    <p class="color-999 mt4 mb0">动效层级分层就是要为⽤户建⽴⼀种真实的视觉，使得⽤户的浏览⻚⾯更加⾃然流畅、基于动效样式(CSS的基本动效规则，如位移、旋转、缩放、形变)以及物理曲线(缓动曲线规则如线性、加速减速、弹性曲线)来实现⻚⾯动效来实现⻚⾯动效更加符合⽤户的感知和和直觉。</p>
                </div>
                <div class="col-md-8 pt30"><img class="img-responsive" src="assets/animation/真实动效/1真实的动效_空间感.svg"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="row">
                <div class="col-sm-9">
                    <div class="fontsize-16">后台产品的动效层级拆分</div>
                    <p class="color-999 mt4 mb0">现有的后台产品设计中，⽤户看到的每⼀个⻚⾯上的层级区分不够清晰，会影响⽤户对层级中重要信息的阅读，通过重新梳理⽤户浏览界⾯内容的层级，进⾏有效的分层，从⽽找到适合产品的动效运动范围。使得同⼀层级下的动效感受是⼀致的，必须说明是后台产品的动效是辅助于设计的存在，应更加突出功能性，减少形式美⽽存在的动效。</p>
                </div>
                <div class="col-sm-9 mt20"><img class="img-responsive" src="assets/animation/真实动效/2真实的动效_立构.svg"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="row">
                <div class="col-md-4">
                    <div class="fontsize-16">从层级中梳理动效曲线范围</div>
                    <p class="color-999 mt4 mb0">通过梳理层级发现最上层的⻚⾯⾯积最⼤，⻚⾯的⾯积会影响动效的⼒度和样式。在与场景相结合的基础上。⾯积越⼤、层级相对较⾼的场景，需要更加舒缓和⾃然的曲线。相反，⾯积较⼩、层级较低的场景，则需要回弹，抖动，缩放等⽅式来吸引⽤户的注意⼒。</p>
                </div>
                <div class="col-md-8 pt30"><img class="img-responsive" src="assets/animation/真实动效/3真实的动效_场景.svg"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="row">
                <div class="col-md-4">
                    <div class="fontsize-16">动效在层级中的曲线规则</div>
                    <p class="color-999 mt4 mb0">通过分析层级背后的逻辑，以及层级的产品功能从⽽梳理出适合的曲线规则，复⽤在后台⼯具产品上，传递给⽤户⼀致的动效体验，同时也对动效场景的扩展提供延续性设计。</p>
                </div>
                <div class="col-md-8 pt30"><img class="img-responsive" src="assets/animation/真实动效/4真实的动效_曲线分层.svg"></div>
            </div>
        </div>
        <div class="mb60">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="fontsize-16">元素在产品中的使⽤⽅法</div>
                        <p class="color-999 mt4 mb10">结合⽤户的使⽤效率，和对内容的理解来看，重新梳理⻚⾯元素的运动轨迹是否需要完全展现，最终定义了合理的展现范围，当⻚⾯⼤⼩⼩于980x300时，则运动轨迹完全展现，当⻚⾯⼤于980x300时，则采⽤错位移动的⽅法解决展现问题，缩短位移路径，强化位移结果。</p>
                    </div>
                    <div class="col-sm-9 mb20"><img class="img-responsive" src="assets/animation/真实动效/5真实的动效_跟随浮层.gif"></div>
                    <div class="col-sm-9"><img class="img-responsive" src="assets/animation/真实动效/6真实的动效_全局浮层.gif"></div>
                </div>
...
<div class="spec-section mb40">
    ...
    <div>
        <div class="mb60">
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <p class="color-999 mt4 mb10">因⽤户的设备不同，屏幕不同，导致产品⾊彩在不同设备下显⽰效果差异较⼤，因此，通过动效来强化⽤户的触发操作，针对按钮和其他触发操作设计了不同的解决⽅案。来解决⽤户关键的悬停点按操作。</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="mb60">
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <p class="color-999 mt4 mb10">⽤户执⾏“确认”“刷新”“上传”等操作时，需要给出⽤户的预计等待时间及反馈样式，等待时间提供给⽤户，明确操作的反馈状态及完成时间，使得⽤户执⾏的操作都是有预期、可完成的。增强⽤户的信⼼及操作效率。因此在设计等待时间时，提供了两种设计规范。</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="mb60">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <p class="color-999 mt4 mb10">在设计中，当有同⼀触发区域涉及多种交互动作，⽆法判断⽤户下⼀步的操作是什么时，可使⽤动效延迟的做法，当然，必须要说的动效延迟是⼀种慎⽤的做法，延迟的时间，需要反复多次的校正和调试，⽽下述⽰例，也是在反复调试下测试出的延迟时间。</p>
                </div>
            </div>
            <div class="row">
    ...
    <div>
        <div class="mb60">
            ...
            <div class="row"><div class="col-sm-9">
                <p class="color-999 mt4 mb10">基于真实的动效的层级梳理，在⼀致性的原则下，梳理出不同的曲线样式，对应在不同⽓氛中曲线规则按照下述适⽤场景划分，使得⽤户在产品曲线的感受是⼀致的，除此之外，这⾥的曲线还应⽤在界⾯间的专场、元素的出现和退出以及动态的反馈中。</p>
            </div></div>
            <blockquote>
                <p>已将函数 Ease and Wizz 打包成组，在设计过程中可通过使⽤统⼀函数来获得⼀致体验。</p>
            </blockquote>
            <div class="row">
                <div class="col-sm-9"><img class="img-responsive" src="assets/animation/遵循法则/1遵循法则_曲线.svg"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="fontsize-16 mb10">引导⽤户有序的阅读</div>
            <div class="row"><div class="col-sm-9">
                <p class="color-999 mt4 mb10">当⻚⾯被刷新，或进⾏全局过渡变化时，需考虑元素的进⼊顺序和进⼊逻辑，保证信息有效的被传达，同时符合⽤户的阅读规则，这部分内容不应单独的存在，需结合上述的曲线规则来使⽤。在设计过程中需考虑元素主次，进⾏有效划分，从⽽使得动效⾃然、流畅。避免给⽤户传达⽣硬，脱节的感受。</p>
            </div></div>
            <div class="row">
                <div class="col-sm-9"><img class="img-responsive" src="assets/animation/遵循法则/2遵循法则_有序阅读.gif"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="fontsize-16 mb10">告知⽤户元素的从属关系</div>
            <div class="row"><div class="col-sm-9">
                <p class="color-999 mt4 mb10">当⽤户呼出组件或是⻚⾯跟随浮层时，应当告知⽤户浮层来源及从属关系，明确触发区域和反馈区域，传递给⽤户明确落脚地奥，同时应避免动效幅度过⼤，影响⽤户阅读内容。</p>
            </div></div>
            <div class="row">
                <div class="col-sm-9 mb20"><img class="img-responsive" src="assets/animation/遵循法则/3遵循法则_从属关系控件.gif"></div>
                <div class="col-sm-9"><img class="img-responsive" src="assets/animation/遵循法则/4遵循法则_从属关系浮层.gif"></div>
            </div>
        </div>
        <div class="mb60">
            <div class="fontsize-16 mb10">赋予⻚⾯唯⼀的动效关系</div>
            <div class="row"><div class="col-sm-9">
                <p class="color-999 mt4 mb10">动效在⻚⾯中承载产品功能的传达，因此当⻚⾯动效发⽣时，应保证有且只有⼀个动效主体运动，保证动效元素的唯⼀性，有助于帮助⽤户明确运动的主体物，及运动关系。</p>
            </div></div>
            <div class="row">
                <div class="col-sm-9"><img class="img-responsive" src="assets/animation/遵循法则/5寻则法则_动效唯一.gif"></div>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row mb60">
            <div class="col-sm-4" style="max-width: 340px;">
                <div style="position: relative; max-width: 280px;">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/01辅形-面.svg">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/03辅形－单色logo.svg" style="
                        position: absolute;
                        left: 25%;
                        width: 50%;
                        top: 38%;
            ...
            <div class="col-sm-4" style="max-width: 340px;">
                <div style="position: relative; max-width: 280px;">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/02辅形-线.svg">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4" style="max-width: 340px;">
                <div style="position: relative; max-width: 280px;">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/04辅形－面.svg">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/03辅形－单色logo.svg" style="
                        position: absolute;
                        left: 23%;
                        width: 50%;
            ...
            <div class="col-sm-4" style="max-width: 340px;">
                <div style="position: relative; max-width: 280px;">
                    <img class="img-responsive" src="alimama/brand/assets/shapes/05辅形－线.svg">
                </div>
            </div>
        </div>
    </div>

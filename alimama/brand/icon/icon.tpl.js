...
<div class="brand">
    ...
    <div class="spec-section brand-icon mb40">
        ...
        <div class="fangge mb60">
            ...
            <div class="row mb20">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/01-64方格.svg">
                    <p class="text-center">64 方格</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/02-1024方格.svg">
                    <p class="text-center">1024 方格</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/03-圆形图标.svg">
                    <p class="text-center">圆形图标</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/04-方形图标.svg">
                    <p class="text-center">方形图标</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/05-竖向图标.svg">
                    <p class="text-center">竖向图标</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/06-横向图标.svg">
        ...
        <div class="fangge mb60">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/07-方形图标案例.svg">
                    <p class="text-center">方形图标</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/08-竖向图标案例.svg">
                    <p class="text-center">竖向图标</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/09-圆形图标案例.svg">
                    <p class="text-center">圆形图标</p>
                </div>
            </div>
        </div>
        <div class="biaochi mb60">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/10-方形图标线标尺.svg">
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/11-圆形图标线标尺.svg">
                </div>
            </div>
        </div>
        <div class="shili-1 mb60">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <img class="img-responsive" src="alimama/brand/assets/icon/12-全域营销图例.svg">
                    <p class="text-center fontsize-16 bold mt10 mb4">全域营销</p>
                    <p>通过领先的消费者人群分析技术,帮助用户精准定向人群,管理受众,实现高效营销推广。</p>
                </div>
                <div class="col-sm-4">
                    <img class="img-responsive" src="alimama/brand/assets/icon/14-达摩院图例.svg">
                    <p class="text-center fontsize-16 bold mt10 mb4">达摩院</p>
                    <p>通过领先的消费者人群分析技术,帮助用户精准定向人群,管理受众,实现高效营销推广</p>
                </div>
                <div class="col-sm-4">
                    <img class="img-responsive" src="alimama/brand/assets/icon/16-新媒体图例.svg">
        ...
        <div class="shili-2 mb60">
            ...
            <div class="row mb20">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/18-海量标签自由组合.svg">
                    <p class="text-center mt10 mb0">海量标签</p>
                    <p class="text-center">自由组合</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/19-引领强劲商业推广.svg">
                    <p class="text-center mt10 mb0">引领强劲</p>
                    <p class="text-center">商业推广</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/20-线上线下综合应用.svg">
                    <p class="text-center mt10 mb0">线上线下</p>
                    <p class="text-center">综合应用</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/21-数据价值最大化.svg">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/22-覆盖上亿人群.svg">
                    <p class="text-center mt10 mb0">覆盖</p>
                    <p class="text-center">上亿人群</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/23-智能扩展优质人群.svg">
                    <p class="text-center mt10 mb0">智能扩展</p>
                    <p class="text-center">优质人群</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/24-安全稳定数据管理.svg">
                    <p class="text-center mt10 mb0">安全稳定</p>
                    <p class="text-center">数据管理</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="alimama/brand/assets/icon/25-第三方服务个性化营销.svg">

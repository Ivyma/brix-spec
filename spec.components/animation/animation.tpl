    ...
    <div>
        <div class="mb40">
            <div class="row">
                ...
                <div class="col-sm-6"><img class="img-responsive" src="assets/animation/真实的动效_小图.svg"></div>
            </div>
        </div>
        <div class="mb40">
            <div class="row">
                ...
                <div class="col-sm-12"><img class="img-responsive" src="assets/animation/真实的动效_立体结构图2.svg"></div>
            </div>
        </div>
        <div class="mb40">
            <div class="row">
                ...
                <div class="col-sm-6"><img class="img-responsive" src="assets/animation/真实的动效_层级说明.svg"></div>
            </div>
        </div>
        <div class="mb40">
            <div class="row">
                ...
                <div class="col-sm-6"><img class="img-responsive" src="assets/animation/真实的动效_层级对应动效.svg"></div>
            </div>
        </div>
        <div class="mb40">

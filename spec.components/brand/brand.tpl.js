...
<div class="brand">
    ...
    <div class="spec-section brand-logo" style="display: none;">
        <div class="clearfix"> 
    ...
    <div class="spec-section brand-character" style="display: none;">
        <div class="clearfix"> 
    ...
    <div class="spec-section brand-typography mb40" style="display: none;">
        <div class="clearfix"> 
    ...
    <div class="spec-section brand-color-palettes" style="display: none;">
        <div class="clearfix">
    ...
    <div class="spec-section brand-shapes mb40" style="display: none;">
        <div class="clearfix">
    ...
    <div class="spec-section brand-icon mb40" style="display: none;">
        <div class="clearfix">
    ...
    <div class="spec-section brand-grid" style="display: none;">
        <div class="clearfix">
    ...
    <div class="spec-section brand-examples" style="display: none;">
        <div class="clearfix">

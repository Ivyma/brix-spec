    ...
    <div class="spec-section brand-story mb40" style="">
        ...
        <div class="row mb40">
            <div class="col-sm-7" style="margin-top: 7%;">
                ...
                <a class="btn btn-brand" href="download/品牌故事/Alimama品牌指南第一版.pdf">
                    <span class="specfont">&#xe633;</span>
                    <span>下载品牌指南</span>
                </a>
            </div>
            <div class="col-sm-4 design-decoration">
                <img class="img-responsive" src="assets/design/landing/字母B.gif">
            </div>
        </div>
        <div class="mb40 brand-personality">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <img src="assets/story/20151206/袋鼠头像.svg">
                </div>
                <div class="col-sm-5">
                    <div class="border-left-brand mb20" style="float: right; clear: both;">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="text-center mb10">
                        <img src="assets/story/20151206/生活化.svg">
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="text-center mb10">
                        <img src="assets/story/20151206/温情.svg">
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="text-center mb10">
                        <img src="assets/story/20151206/活力.svg">
                    </div>
        ...
        <div class="mb40 brand-download">
            ...
            <div class="row text-center">
                <div class="col-sm-3">
                    <div class="mb10">
                        <a href="download/标志/阿里妈妈品牌规范-标志.ai" class="item">
                            <img src="assets/story/20151206/标识.svg">
                        </a>
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="mb10 item">
                        <a href="download/吉祥物/阿里妈妈品牌规范-吉祥物（校正）.ai" class="item">
                ...
                <div class="col-sm-3">
                    <div class="mb10 item">
                        <a href="download/案例/PPT模板.zip" class="item">
                            <img src="assets/story/20151206/ppt.svg">
                        </a>
                    </div>
